...
<channel>
	...
	<atom:link href="<?php echo site_url() . '/' . bp_links_root_slug() ?>" rel="alternate" type="text/html" />
	<link><?php echo site_url() . '/' . bp_links_root_slug() ?></link>
	...
	<?php if ( bp_has_links( 'type=newest&max=50' ) ) : ?>
		<?php while ( bp_links() ) : bp_the_link(); ?>
			<item>
				...
				<description><![CDATA[<?php bp_link_feed_item_description() ?>]]></description>
